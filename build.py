    ...
    <table>
      <thead>
        <tr>
          ...
          <th data-key="score" class="num-col has-tip" data-tip="F1(Precision, Recall), macro-averaged per evolution range. Primary metric.">Score (%)</th>
          <th data-key="precision" class="num-col has-tip" data-tip="(fixed+1)/(fixed+broken+1), measures regression avoidance. Macro-avg per evolution range.">Precision (%)</th>
          <th data-key="recall" class="num-col has-tip" data-tip="fixed/target, measures how many required tests are fixed. Macro-avg per evolution range.">Recall (%)</th>
          <th data-key="resolve" class="num-col has-tip" data-tip="% of milestones fully resolved (all tests pass). Macro-avg per evolution range.">Resolve (%)</th>
